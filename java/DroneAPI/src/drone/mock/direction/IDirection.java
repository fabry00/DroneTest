 ...
 * the Polymorphism. Benefits: - This technique adheres to the Tell-Don't-Ask
 ...
 * needs to do and let it decide for itself how to do that. - Removes duplicate
 * code. You get rid of many almost identical conditionals. - If you need to add
 * a new execution variant, all you need to do is add a new subclass without
